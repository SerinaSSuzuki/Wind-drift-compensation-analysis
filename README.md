...
The raw GPS data used for this analysis are archived in the Biologging Intelligent Platform (BiP; https://www.bip-earth.com) and are fully available. Please submit a data access request through the platform to download the data.
